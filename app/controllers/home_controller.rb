...
class HomeController < ApplicationController
  def payroll_parse
    @company = Company.find(params[:company_payroll][:com])
    ...
    if @company_payroll.save
      ...
      redirect_to company_company_payroll_employee_salaries(company_id: params[:company_payroll][:company_id],
                                                            company_payroll_id: @company_payroll.id), notice: 'Payroll uploaded successfully'
    else
